...
public class CowboyBossMoveToLaughingPositionState : CowboyBossSuperState{
    public CowboyBossMoveToLaughingPositionState(CowboyBoss cowboyBoss, CowboyBossStateMachine cowboyBossStateMachine) : base(cowboyBoss, cowboyBossStateMachine){
    }
    Vector3 startPos;
