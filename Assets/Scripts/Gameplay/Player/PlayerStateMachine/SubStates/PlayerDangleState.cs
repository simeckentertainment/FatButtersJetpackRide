...
public class PlayerDangleState : PlayerAliveState
{
    public PlayerDangleState(Player player, PlayerStateMachine playerStateMachine) : base(player, playerStateMachine){
